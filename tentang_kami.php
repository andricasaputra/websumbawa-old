					...
					<div class="mz-module" >
						<div class="mz-module-about text-center" >
							<div class="section-title">
							 ...
							 <p>
							 	<img data-frz-src="assets/img/org/struktur.png" width="700" alt="struktur" src=data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw== onload=lzld(this) onerror=lzld(this) />	 
							</p>
							<br>
							<a href="home" class="button-cta btn-berita">Kembali</a>
						</div>					
